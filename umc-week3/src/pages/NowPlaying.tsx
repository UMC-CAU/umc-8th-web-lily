...
export const NowPlaying = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      min_date.setDate(max_date.getDate() - 5);
      ...
      try {
        ...
        const response = await axios.get(
          `https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=${currentPage}&sort_by=popularity.desc&with_release_type=2|3&release_date.gte=${formatDate(min_date)}&release_date.lte=${formatDate(max_date)}`,
          {
            headers: {
              Authorization:
